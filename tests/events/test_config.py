from aws_lambda_typing.events import ConfigEvent


def test_config_event() -> None:
    event: ConfigEvent = {
        ...
        "configRuleArn": "arn:aws:config:us-east-1:012345678912:config-rule/config-rule-0123456",  # noqa: E501
